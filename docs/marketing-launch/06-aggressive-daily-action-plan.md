# Aggressive 90-Day Daily Action Plan
...
Use the morning for creation and setup:

- publish or draft one high-value asset
- review overnight metrics
- schedule social posts
- send the day’s outreach
- prepare one distribution angle

### Midday block

Use midday for visibility and engagement:

- respond to comments
- post social content
- engage in communities
- follow up on replies
- share the latest content asset

### Evening block

Use evening for optimization and learning:

- review traffic and conversions
- write down what worked
- update the funnel or CTA
- capture learnings for the next day
- schedule tomorrow’s priority task
...
## Days 1-7: Positioning and launch foundation
...
## Days 8-14: Content engine starts
...
- Run a weekly metric review
- Identify top 3 content themes
- Identify top 3 distribution posts
- Update the next week’s content calendar
- Adjust the workflow based on what performed best
- Decide one thing to stop doing next week

---

## Days 15-21: Distribution acceleration
...
## Days 61-75: Amplify the winners
...
## Days 76-90: Conversion, proof, and final push
...
If a day is missed, do not compensate with random activity.

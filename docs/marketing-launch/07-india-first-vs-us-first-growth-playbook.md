# India-First vs US-First Growth Playbook
...
## 3) India-first vs US-first channel mix
...
## 4) 90-day execution differences

### If going India-first
...
### If you need fast attention now

Go India-first.

### If you need durable inbound compounding

Go US-first.

### If you need both

Use India-first as the launch amplifier and US-first as the long-term content engine.
...
The regional strategy should change the examples, channels, and proof points.

...
const PROMPT_MATRIX: PromptTestCase[] = [
  // ── STARTER ────────────────────────────────────────────────────────────────
  { id: "starter-simple-edu",    plan: "STARTER", tier: "SIMPLE",   family: "educational",  query: "What is volatility score?",        context: { assetType: "STOCK" },                              optimizationTest: "EDU_CACHE" },
  { id: "starter-simple-signal", plan: "STARTER", tier: "SIMPLE",   family: "single-asset", query: "TSLA breakdown",                   context: { symbol: "TSLA", assetType: "STOCK" } },
  { id: "starter-trivial",       plan: "STARTER", tier: "SIMPLE",   family: "trivial",      query: "hi",                              context: { assetType: "GLOBAL" },                             optimizationTest: "CANNED" },
  { id: "starter-moderate",      plan: "STARTER", tier: "MODERATE", family: "single-asset", query: "Analyze AAPL",                    context: { symbol: "AAPL", assetType: "STOCK", scores: { trend: 75, momentum: 68 } } },
  ...
  { id: "starter-complex",       plan: "STARTER", tier: "COMPLEX",  family: "comparative",  query: "Compare AAPL vs MSFT",            context: { assetType: "STOCK" } },

  // ── PRO ────────────────────────────────────────────────────────────────────
  { id: "pro-simple-edu",        plan: "PRO",    tier: "SIMPLE",   family: "educational",  query: "What is trend score?",              context: { assetType: "STOCK" },                              optimizationTest: "EDU_CACHE" },
  { id: "pro-simple-signal",     plan: "PRO",    tier: "SIMPLE",   family: "single-asset", query: "NVDA signal",                       context: { symbol: "NVDA", assetType: "STOCK" } },
  { id: "pro-moderate-nvda",     plan: "PRO",    tier: "MODERATE", family: "single-asset", query: "What's driving NVDA?",              context: { symbol: "NVDA", assetType: "STOCK", scores: { trend: 82, momentum: 58 } }, optimizationTest: "COT" },
  { id: "pro-moderate-spy",      plan: "PRO",    tier: "MODERATE", family: "etf",          query: "SPY analysis",                      context: { symbol: "SPY",  assetType: "ETF" } },
  { id: "pro-complex-cmp",       plan: "PRO",    tier: "COMPLEX",  family: "comparative",  query: "Compare NVDA vs AMD",               context: { assetType: "STOCK" } },
  { id: "pro-complex-macro",     plan: "PRO",    tier: "COMPLEX",  family: "macro",        query: "Market regime analysis",            context: { assetType: "GLOBAL" } },

  // ── ELITE ──────────────────────────────────────────────────────────────────
  { id: "elite-simple-edu",      plan: "ELITE",  tier: "SIMPLE",   family: "educational",  query: "What is momentum?",                 context: { assetType: "STOCK" },                              optimizationTest: "EDU_CACHE" },
  { id: "elite-simple-signal",   plan: "ELITE",  tier: "SIMPLE",   family: "single-asset", query: "AAPL breakdown",                    context: { symbol: "AAPL", assetType: "STOCK" } },
  { id: "elite-moderate-deep",   plan: "ELITE",  tier: "MODERATE", family: "single-asset", query: "AAPL deep dive — factor alignment", context: { symbol: "AAPL", assetType: "STOCK", scores: { trend: 78, momentum: 72 } }, optimizationTest: "COT" },
  { id: "elite-moderate-gold",   plan: "ELITE",  tier: "MODERATE", family: "commodity",    query: "Gold analysis",                     context: { symbol: "GC=F", assetType: "COMMODITY" } },
  { id: "elite-complex-cmp3",    plan: "ELITE",  tier: "COMPLEX",  family: "comparative",  query: "NVDA vs AMD vs INTC — which wins?", context: { assetType: "STOCK" } },
  { id: "elite-complex-regime",  plan: "ELITE",  tier: "COMPLEX",  family: "sector",       query: "Sector rotation — where to position now?", context: { assetType: "GLOBAL" } },

  // ── ENTERPRISE ─────────────────────────────────────────────────────────────
  { id: "ent-simple-edu",        plan: "ENTERPRISE", tier: "SIMPLE",   family: "educational",  query: "What is momentum score?",              context: { assetType: "STOCK" },                              optimizationTest: "EDU_CACHE" },
  { id: "ent-moderate-aapl",     plan: "ENTERPRISE", tier: "MODERATE", family: "single-asset", query: "AAPL deep dive analysis",              context: { symbol: "AAPL", assetType: "STOCK", scores: { trend: 78, momentum: 72 } } },
  { id: "ent-moderate-fed",      plan: "ENTERPRISE", tier: "MODERATE", family: "macro",        query: "Fed rate impact on tech sector",        context: { assetType: "GLOBAL" } },
  {
    id: "ent-complex-portfolio",
    plan: "ENTERPRISE",
    tier: "COMPLEX",
    family: "full-analysis",
    query: "Portfolio analysis: concentration, correlation, fragility, and strategic adjustments",
    context: {
      assetType: "GLOBAL",
      assetName: "Core Multi-Asset Portfolio",
      portfolioHealth: {
        healthScore: 54,
        band: "Balanced",
        holdingCount: 6,
      ...
      portfolioFragility: {
        ...
        topDrivers: [
          "Tech concentration remains above 40%",
          "Equity-beta overlap increases rotation sensitivity",
          "Gold hedge is too small to offset growth drawdowns",
        ],
      },
      portfolioSimulation: {
  ...
  { id: "ent-complex-rotation",  plan: "ENTERPRISE", tier: "COMPLEX",  family: "multi-asset",  query: "Sector rotation analysis with macro regime", context: { assetType: "GLOBAL" } },
  ...
  // These should receive Elite COMPLEX specs regardless of plan
  {
    ...
    tier: "COMPLEX",
    family: "compare-mode",
    query: "Compare AAPL vs MSFT: which has stronger momentum, better risk-adjusted return, and which is more regime-aligned?",
    context: {
      symbol: "GLOBAL",
      assetType: "GLOBAL",
      assetName: "Comparison: AAPL, MSFT",
      chatMode: "compare",
      compareContext: [
        { symbol: "AAPL", name: "Apple Inc.",     scores: { trend: 78, momentum: 72, volatility: 45, liquidity: 90, sentiment: 71, trust: 82 }, signal: 78, signalLabel: "Strong Buy", performance: { "1W": 2.1, "1M": 4.5, "3M": 12.3, "1Y": 28.7 } },
        { symbol: "MSFT", name: "Microsoft Corp", scores: { trend: 81, momentum: 68, volatility: 38, liquidity: 92, sentiment: 74, trust: 88 }, signal: 81, signalLabel: "Strong Buy", performance: { "1W": 1.8, "1M": 3.9, "3M": 10.1, "1Y": 22.4 } },
      ],
    },
  ...
  },
  {
    ...
    tier: "COMPLEX",
    family: "compare-mode",
    query: "Compare NVDA vs AMD vs INTC — factor analysis, momentum divergence, and regime fit verdict.",
    context: {
      symbol: "GLOBAL",
      assetType: "GLOBAL",
      assetName: "Comparison: NVDA, AMD, INTC",
      chatMode: "compare",
      compareContext: [
        { symbol: "NVDA", name: "NVIDIA Corp",  scores: { trend: 88, momentum: 85, volatility: 60, liquidity: 91 }, signal: 88, signalLabel: "Strong Buy",  performance: { "1M": 12.1, "3M": 35.0, "1Y": 95.0 } },
        { symbol: "AMD",  name: "AMD Inc.",     scores: { trend: 71, momentum: 65, volatility: 55, liquidity: 84 }, signal: 71, signalLabel: "Buy",          performance: { "1M": 5.2,  "3M": 14.0, "1Y": 30.0 } },
        { symbol: "INTC", name: "Intel Corp",   scores: { trend: 42, momentum: 35, volatility: 48, liquidity: 88 }, signal: 42, signalLabel: "Neutral",      performance: { "1M": -3.1, "3M": -8.5, "1Y": -18.0 } },
      ],
    },
    optimizationTest: "COMPARE_MODE",
    wordBudgetKey: "COMPARE",
  },
  {
    ...
    tier: "COMPLEX",
    family: "stress-mode",
    query: "Stress test during GFC 2008 (US market, Sep 2008–Mar 2009): AAPL: -52.3% max drawdown, -48.1% period return; BTC-USD: N/A (pre-2009); GLD: +5.8% max drawdown, +12.0% period return; SPY: -56.8% max drawdown, -54.2% period return. What are the best hedging strategies for this portfolio? Which assets provided the best protection? What should I add or remove to improve resilience?",
    context: {
      symbol: "GLOBAL",
      assetType: "GLOBAL",
      assetName: "Portfolio Stress Test",
  ...
  },
  {
    ...
    tier: "COMPLEX",
    family: "stress-mode",
    query: "Stress test during COVID 2020 (US market, Feb 2020–Apr 2020): TSLA: -60.6% max drawdown, period +30% (dramatic V-recovery); QQQ: -29.0% max, -20.8% period; GLD: -12.8% max, +1.2% period. Suggest hedging strategies and portfolio improvements.",
    context: {
      symbol: "GLOBAL",
      assetType: "GLOBAL",
      assetName: "Portfolio Stress Test",
  ...
  // ── v9: LYRA WORKFLOW / PLATFORM KNOWLEDGE ─────────────────────────────────
  {
    ...
    query: "How do I get the best analysis from Lyra? Walk me through the workflow.",
  ...
  // ── v9: ARCS REGIME CONTEXT ────────────────────────────────────────────────
  {
    ...
    tier: "MODERATE",
    family: "single-asset",
    query: "Is NVDA well-positioned for the current regime? Check its ARCS score and factor alignment.",
    context: {
      symbol: "NVDA",
      assetType: "STOCK",
  ...
  },
  {
    ...
    tier: "COMPLEX",
    family: "full-analysis",
    query: "Which of my holdings are regime-misaligned right now? Use ARCS scores to identify the weakest fits.",
    context: {
      assetType: "GLOBAL",
  ...
  // ── v9: INDIA MARKET GATING ────────────────────────────────────────────────
  {
    ...
    tier: "MODERATE",
    family: "intelligence",
    query: "Analyze Nifty 50 — what is the current market regime in India and how does RBI policy affect the outlook?",
    context: { symbol: "^NSEI", assetType: "INDEX", region: "IN" },
  ...
  // ── v9: MACRO-TO-MICRO WORKFLOW ────────────────────────────────────────────
  {
    ...
    tier: "COMPLEX",
    family: "macro",
    query: "Start from the macro picture — GDP, inflation, Fed policy — then walk me into which sectors benefit, and then name the top asset to position in right now.",
  ...
  },
  {
    ...
    tier: "COMPLEX",
    family: "macro",
    query: "Macro-to-micro analysis: current US economic regime → sector rotation → single highest-conviction equity pick with full factor rationale.",

...
export function AuthButton({ href, children, variant = "default", icon }: AuthButtonProps) {
  ...
  const variants: Record<AuthButtonVariant, string> = {
    default: "border border-slate-200 bg-white/90 text-slate-700 hover:bg-white dark:border-white/8 dark:bg-white/3 dark:text-white/80 dark:hover:bg-white/8",

...
export function PublicToolPage({
  ...
  return (
    <div
      className="flex h-dvh flex-col overflow-x-hidden bg-[#040816] font-sans text-white selection:bg-warning1816"
      ...
      >
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              ...
              <div className="rounded-[2.8rem] border border-white/10 bg-white/2.8 p-8 shadow-[0_28px_90px_rgba(0,0,0,0.32)] backdrop-blur-xl sm:p-10">
                ...
                {ctaLabel && ctaHref && (
                  <div className="mt-8">
                    <Link
                      href={ctaHref}
                      className="group inline-flex items-center gap-2.5 rounded-full border border-warning/30 bg-warning px-8 py-3.5 font-mono text-sm font-bold text-foreground shadow-[0_0_40px_rgba(245,158,11,0.25)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-warning4901 hover:shadow-[0_0_60px_rgba(245,158,11,0.4)]"
                    >
                      {ctaLabel}
              ...
              <div className="rounded-[2.4rem] border border-white/10 bg-white/2.5 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.3)] backdrop-blur-xl sm:p-8">
                <p className="font-mono text-[10px] font-bold uppercase tracking-[0.3em] text-warning/70">
                  {systemLabel}
                </p>
            ...
            <div className="rounded-[2.4rem] border border-white/10 bg-white/2 p-6 shadow-[0_20px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:p-8">
              ...
              <div className="mt-6 grid gap-4 lg:grid-cols-3">
                {examples.map((example) => (
                  ...
                  >
                    <p className="font-mono text-[9px] font-bold uppercase tracking-[0.28em] text-warning/70">
                      {example.label}
                    </p>
                    <div className="mt-4 rounded-[1.35rem] border border-white/8 bg-black/30 p-4">
                      <p className="font-mono text-[9px] font-bold uppercase tracking-[0.2em] text-info/60">
                        Input
                      </p>
                      <p className="mt-2 text-sm leading-6 text-white/58">{example.prompt}</p>
                    </div>
                    <div className="mt-3 rounded-[1.35rem] border border-warning/20 bg-warning/5 p-4">
                      <p className="font-mono text-[9px] font-bold uppercase tracking-[0.2em] text-warning/70">
                        Output
                      </p>
                ...
                <table className="min-w-full border-separate border-spacing-0 overflow-hidden rounded-[1.6rem] border border-white/8">
                  <thead>
                    <tr className="bg-black/20">
                      ...
                      <th className="px-5 py-3.5 text-left font-mono text-[9px] font-bold uppercase tracking-[0.22em] text-warning/70">
                        LyraAlpha
                      </th>
                      <th className="px-5 py-3.5 text-left font-mono text-[9px] font-bold uppercase tracking-[0.22em] text-white/38">
                        {comparisonAlternativeLabel}
              ...
              <div className="rounded-[2.4rem] border border-white/10 bg-white/2 p-6 shadow-[0_20px_70px_rgba(0,0,0,0.24)] backdrop-blur-xl sm:p-8">
                ...
                <div className="mt-5 space-y-3">
                  {seoBullets.map((bullet) => (
                    ...
                    >
                      <ChevronRight className="mt-0.5 h-3.5 w-3.5 shrink-0 text-warning/60" />
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                {relatedTools.map((tool) => (
                  <Link
                    key={tool.href}
                    href={tool.href}
                    className="group rounded-[1.8rem] border border-white/8 bg-white/3 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-warning/25 hover:bg-warning/5"
                  >
                    <div className="flex items-center justify-between gap-2">
                      <h3 className="text-base font-bold tracking-tight text-white">{tool.title}</h3>
                      <ArrowRight className="h-4 w-4 shrink-0 text-white/25 transition-all duration-300 group-hover:translate-x-0.5 group-hover:text-warning/70" />
                    </div>
        ...
        {ctaLabel && ctaHref && (
          <section className="px-4 pb-16 pt-4 sm:px-6">
            <div className="mx-auto max-w-7xl">
              <div className="relative overflow-hidden rounded-[2.4rem] border border-warning/20 bg-[linear-gradient(135deg,rgba(245,158,11,0.1),rgba(129,140,248,0.06)_50%,rgba(245,158,11,0.08))] p-8 shadow-[0_0_80px_rgba(245,158,11,0.08)] sm:p-10">

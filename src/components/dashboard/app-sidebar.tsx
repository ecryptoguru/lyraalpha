    ...
    >
      <SidebarHeader className="pt-5 pb-2">
        ...
        <div className="hidden group-data-[collapsible=icon]:flex justify-center px-2 py-1">
          <Link href="/" className="flex items-center justify-center rounded-2xl size-10 bg-linear-to-br from-cyan-500/20 to-cyan-400/10 border border-cyan-400/30 shadow-[0_0_15px_rgba(0,212,255,0.25)] hover:opacity-80 transition-opacity">
        ...
        <div className="group-data-[collapsible=icon]:hidden px-2">
          <Link href="/" className="flex items-center gap-2 rounded-xl hover:bg-muted/40 dark:hover:bg-white/5 transition-colors duration-200 px-2 py-2 -mx-2 cursor-pointer">
            {/* Logo image */}
            <Image
              ...
              height={95}
              priority
              className="h-[68px] w-auto max-w-[200px] object-contain object-left shrink-0"
            />
            {/* Beta badge centered with logo */}
                      ...
                      <SidebarMenuItem key={item.title}>
                        <SidebarMenuButton
                          ...
                          className={`
                            ...
                            ${
                              isActive
                                ? "bg-cyan-500/10 text-cyan-400 shadow-[0_0_12px_rgba(0,212,255,0.15)] border border-cyan-400/25"
                          ...
                          >
                            <ItemIcon
                              className={`
                                ...
                                ${isActive ? "text-cyan-400 drop-shadow-[0_0_6px_rgba(0,212,255,0.45)]" : "opacity-70 group-hover/item:opacity-100"}
                              `}
                            />
                            <span
                              className={`
                            ...
                            {item.key === "watchlist" && driftCount > 0 && (
                              <span className="ml-auto shrink-0 inline-flex items-center justify-center rounded-full bg-cyan-400/15 border border-cyan-400/30 px-1.5 min-w-[18px] h-[18px] text-[9px] font-bold text-cyan-400 group-data-[collapsible=icon]:hidden">
                                {driftCount}
                              </span>
                            )}

                            {isActive && (
                              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-cyan-400 rounded-r-full shadow-[0_0_10px_rgba(0,212,255,0.6)] group-data-[collapsible=icon]:hidden" />
                            )}
                          </Link>
                        </SidebarMenuButton>
                      </SidebarMenuItem>
        ...
        {showDeferredExtras ? (
          ...
          <>
            <div className="mb-3 overflow-hidden rounded-2xl border border-border/50 bg-card/70 p-4 shadow-lg backdrop-blur-2xl group-data-[collapsible=icon]:hidden">
              ...
              <div className="mb-2 h-4 w-28 rounded-full bg-cyan-500/15" />
                ...
                <div className="flex items-center gap-2 group-data-[collapsible=icon]:flex-col group-data-[collapsible=icon]:gap-4">
                  <div className="relative flex-1 group-data-[collapsible=icon]:w-auto group-data-[collapsible=icon]:flex-none">
                    <div className="flex w-full items-center gap-3 rounded-2xl border border-border/75 bg-white/80 p-2 backdrop-blur-2xl dark:border-white/5 dark:bg-white/5 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:border-none group-data-[collapsible=icon]:bg-transparent group-data-[collapsible=icon]:p-0">
                      <div className="relative flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-linear-to-br from-cyan-500/30 to-cyan-400/10 p-[2px] dark:to-black">
                        <div className="absolute inset-0 bg-linear-to-br from-cyan-400 to-transparent opacity-30" />

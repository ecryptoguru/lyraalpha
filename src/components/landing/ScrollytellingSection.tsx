...
function PanelNoise() {
  const noiseRows = [
    { sym: "BTC",  dir: "↑", val: "+8.34%", color: "text-info" },
    { sym: "ETH",  dir: "↓", val: "-3.12%", color: "text-danger" },
    { sym: "SOL",  dir: "↑", val: "+12.1%", color: "text-info" },
    { sym: "BNB",  dir: "↓", val: "-0.92%", color: "text-danger" },
    { sym: "XRP",  dir: "↑", val: "+2.33%", color: "text-info" },
    { sym: "ADA",  dir: "↓", val: "-1.44%", color: "text-danger" },
    { sym: "AVAX", dir: "↑", val: "+5.67%", color: "text-info" },
    { sym: "DOT",  dir: "↓", val: "-4.21%", color: "text-danger" },
  ];
      ...
      <div className="mx-auto w-full max-w-2xl">
        <div className="mb-10">
          ...
          <h2 className="mt-3 text-4xl font-extralight leading-tight tracking-[-0.04em] text-white sm:text-5xl lg:text-6xl">
            Market{" "}
            <span className="font-light text-danger">noise.</span>
          </h2>
    ...
    <div className="flex h-full w-screen shrink-0 flex-col items-center justify-center px-8 py-16 lg:px-16">
      <div className="mx-auto w-full max-w-2xl">
        <div className="mb-10">
          ...
          <h2 className="mt-3 text-4xl font-extralight leading-tight tracking-[-0.04em] text-white sm:text-5xl lg:text-6xl">
            AI <span className="font-light text-warning">processing.</span>
          </h2>
          <p className="mt-4 max-w-lg font-mono text-sm leading-7 text-white/42">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/8 bg-white/3 p-5 backdrop-blur-sm">
          ...
          <svg viewBox="0 0 100 100" className="mx-auto h-48 w-full" preserveAspectRatio="xMidYMid meet">
            {edges.map(([a, b], i) => (
              <line
                ...
                stroke={nodes[a].active && nodes[b].active ? "#22D3EE" : "rgba(255,255,255,0.1)"}
                strokeWidth="0.5"
            ...
            {nodes.map((node) => (
              <g key={node.label}>
                <circle cx={node.x} cy={node.y} r={3.5}
                  fill={node.active ? "#818CF8" : "rgba(255,255,255,0.15)"}
          ...
          <div className="mt-3 grid grid-cols-3 gap-2">
            {[
              ...
              <div key={s.label} className="rounded-lg border border-warning/15 bg-warning/6 px-2 py-2 text-center">
                <p className="font-mono text-base font-bold text-warning">{s.value}</p>
    ...
    <div className="flex h-full w-screen shrink-0 flex-col items-center justify-center px-8 py-16 lg:px-16">
      <div className="mx-auto w-full max-w-2xl">
        <div className="mb-10">
          ...
          <h2 className="mt-3 text-4xl font-extralight leading-tight tracking-[-0.04em] text-white sm:text-5xl lg:text-6xl">
            Actionable <span className="font-light text-info">clarity.</span>
          </h2>
          <p className="mt-4 max-w-lg font-mono text-sm leading-7 text-white/42">
            Structured, traceable intelligence you can act on.
          </p>
        </div>
        <div className="relative overflow-hidden rounded-2xl border border-info/20 bg-white/3 backdrop-blur-sm">
          ...
          <div className="border-b border-white/8 px-5 py-4">
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full border border-info/25 bg-info/8 px-2.5 py-1 font-mono text-[9px] font-bold uppercase tracking-wide text-info">
          ...
          <div className="space-y-3 p-5">
            {[
              { icon: <TrendingUp className="h-3.5 w-3.5" />, label: "Conviction Score",    value: "8.4 / 10", color: "text-info"  },
              { icon: <Brain       className="h-3.5 w-3.5" />, label: "Risk-Adjusted Signal",value: "Bullish",  color: "text-warning" },
            ...
            <div className="rounded-lg border border-info/12 bg-info/4 px-3 py-2.5">
          ...
          <div className="border-t border-white/8 px-5 py-4">
            <Link
              href="/sign-up"
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-warning/25 bg-warning/10 py-2.5 font-mono text-sm font-bold text-warning transition-all hover:bg-warning/18 hover:text-warning"
            >
      ...
      <div className="mx-auto w-full max-w-3xl">
        <div className="mb-8">
          ...
          <h2 className="mt-3 text-4xl font-extralight leading-tight tracking-[-0.04em] text-white sm:text-5xl">
            Full crypto stack.{" "}
            <span className="font-light text-warning">Natively.</span>
          </h2>
          <p className="mt-4 max-w-lg font-mono text-sm leading-7 text-white/42">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="relative overflow-hidden rounded-2xl border border-warning/20 bg-warning/5 p-4">
            <div className="pointer-events-none absolute inset-0 bg-linear-to-br from-warning/6 to-transparent" />
            <p className="font-mono text-[9px] font-bold uppercase tracking-[0.3em] text-warning/70">01 Layer 1</p>
            <p className="mt-2 text-sm font-semibold text-white">BTC, ETH, SOL, ADA · Core</p>
            <ul className="mt-3 space-y-1.5">
              {layer1Features.map((f) => (
                <li key={f} className="flex items-start gap-2">
                  <span className="mt-0.5 text-warning/70 text-[10px]">·</span>
                  <span className="font-mono text-[10px] leading-5 text-white/50">{f}</span>
                </li>
              ))}
            </ul>
          </div>
          <div className="relative overflow-hidden rounded-2xl border border-info/18 bg-info/4 p-4">
            <div className="pointer-events-none absolute inset-0 bg-linear-to-br from-info/5 to-transparent" />
            <p className="font-mono text-[9px] font-bold uppercase tracking-[0.3em] text-info/70">02 Layer 2 & DeFi</p>
            <p className="mt-2 text-sm font-semibold text-white">Scaling & Innovation</p>
            <ul className="mt-3 space-y-1.5">
              {layer2Features.map((f) => (
                <li key={f} className="flex items-start gap-2">
                  <span className="mt-0.5 text-info/70 text-[10px]">·</span>
                  <span className="font-mono text-[10px] leading-5 text-white/50">{f}</span>
                </li>
              ))}
            </ul>
    ...
    <div className="flex h-full w-screen shrink-0 flex-col items-center justify-center px-8 py-16 lg:px-16">
      <div className="mx-auto w-full max-w-3xl">
        <div className="mb-8">
          ...
          <h2 className="mt-3 text-4xl font-extralight leading-tight tracking-[-0.04em] text-white sm:text-5xl">
            Leads across{" "}
            <span className="font-light text-info">all five dimensions.</span>
          </h2>
          <p className="mt-4 max-w-lg font-mono text-sm leading-7 text-white/42">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="mt-4 space-y-2.5">
              {dimensions.map((d) => (
                <div key={d.label} className="flex items-center justify-between border-b border-white/5 pb-2 last:border-0">
                  ...
                  <span className="font-mono text-sm font-bold text-info">{d.score}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="space-y-2">
            ...
            <div className="rounded-xl border border-info/25 bg-info/6 px-4 py-3">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-3.5 w-3.5 shrink-0 text-info" />
                <span className="text-sm font-bold text-info">LyraAlpha AI</span>
              </div>
      ...
      <div className="sticky top-0 h-screen overflow-hidden bg-[#040816]">
        ...
        >
          <div className="relative h-full border-r border-white/5">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_30%_50%,rgba(129,140,248,0.04),transparent_60%)]" />
            <PanelNoise />
          </div>
          <div className="relative h-full border-r border-white/5">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_50%,rgba(34,211,238,0.05),transparent_60%)]" />
            <PanelSignal />
          </div>
          <div className="relative h-full border-r border-white/5">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_70%_50%,rgba(34,211,238,0.06),transparent_60%)]" />
            <PanelClarity />
          </div>
          <div className="relative h-full border-r border-white/5">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_50%,rgba(129,140,248,0.05),transparent_60%)]" />
            <PanelDualMarket />
          </div>
          <div className="relative h-full">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_60%_50%,rgba(34,211,238,0.05),transparent_60%)]" />
            <PanelCompetitive />
          </div>
        </div>

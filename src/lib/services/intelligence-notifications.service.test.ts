...
const weeklyReport: WeeklyIntelligenceReport = {
  ...
  summary: "Biggest risk: Fragile concentration. Best opportunity to investigate: NVDA — momentum is rebuilding.",
  topOpportunity: "NVDA — momentum is rebuilding",
  ...
  share: createShareObject({
    ...
    context: "NVDA — momentum is rebuilding",
    href: "/dashboard?view=weekly-report",
    scoreLabel: "Region",
    scoreValue: "US",
  }),
  ...
  it("builds normalized dashboard notification events", () => {
    const home: DashboardHomeData = {
      ...
      dailyBriefing: {
        ...
        discoveryHighlight: "NVDA surfaced again",
        regimeLabel: "RISK_ON",

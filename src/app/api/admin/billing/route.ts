...
import { getBillingStats } from "@/lib/services/admin.service";
import { createLogger } from "@/lib/logger";
import { sanitizeError } from "@/lib/logger/utils";
import { apiError } from "@/lib/api-response";

const logger = createLogger({ service: "admin-billing" });
...
export async function GET() {
  ...
  try {
    ...
    logger.error({ err: sanitizeError(error) }, "Failed to fetch billing stats");

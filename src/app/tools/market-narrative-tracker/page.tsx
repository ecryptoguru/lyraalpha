...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${process.env.APP_URL || "https://lyraalpha.xyz"}/tools/market-narrative-tracker` },
  openGraph: {
    ...
    url: `${process.env.APP_URL || "https://lyraalpha.xyz"}/tools/market-narrative-tracker`,
    images: ["/og-image.png"],
  },
  twitter: {

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${process.env.APP_URL || "https://lyraalpha.xyz"}/tools/ai-stock-analysis` },
  openGraph: {
    ...
    url: `${process.env.APP_URL || "https://lyraalpha.xyz"}/tools/ai-stock-analysis`,
    images: ["/og-image.png"],
  },
  twitter: {
